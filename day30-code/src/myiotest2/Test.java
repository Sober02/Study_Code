...
public class Test {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("day30-code\\src\\myiotest2\\names.txt"));
        String line;
        ...
        //7.把集合中的数据再次写到文件中
        BufferedWriter bw = new BufferedWriter(new FileWriter("day30-code\\src\\myiotest2\\names.txt"));
        for (Student s : list) {
            bw.write(s.toString());
            bw.newLine();
        }

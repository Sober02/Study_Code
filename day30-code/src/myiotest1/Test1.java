...
public class Test1 {
    public static void main(String[] args) throws IOException {
        /*
        制造假数据：
            获取姓氏：https://hanyu.baidu.com/shici/detail?from=aladdin&pid=0b2f26d4c0ddb3ee693fdb1137ee1b0d&showPinyin=1
        ...
        String girlNameNet = "http://www.haoming8.cn/baobao/7461.html";

        //2.爬取数据，把网址上所欲的数据拼接成一个字符串
        ...
        //5.生成数据
        //姓名（唯一）-性别-年龄
        ArrayList<String> resultList = getInfos(familyNameList, boyNameList, girlNameList, 70, 50);

    ...
    public static void main(String[] args) {
        /*
            需求
                ...
                验证手机号码      13112345678 13712345667 13945679827 139456798271
        ...
        System.out.println("139456798271".matches(regex1));
        System.out.println("----------------------------------");
        ...
        //二: -     ?表示次数，0次或一次
        //三:号码号码的第一位也不能以0开头，从第二位开始可以是任意的数字，号码的总长度: 5-10位
        ...
        String regex5 = "([01]\\d|2[0-3])(:[0-5]\\d){2}"; //把分钟和秒看成一部分，执行两次
        //                  ①和②或者③
        //23:11:11
        //①01 02 03 ... 09
        //②10 11 12 ... 19
